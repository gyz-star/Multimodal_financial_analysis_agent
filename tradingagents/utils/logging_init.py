...
def init_logging(config_override: Optional[dict] = None) -> None:
    ...
    # 记录初始化信息
    logger.info("🚀 Multimodal_financial_analysis_agent 日志系统初始化完成")
...
def log_startup_info():
    ...
    logger.info("=" * 60)
    logger.info("🎯 Multimodal_financial_analysis_agent 启动")
    logger.info("=" * 60)
...
def log_shutdown_info():
    ...
    logger.info("=" * 60)
    logger.info("🛑 Multimodal_financial_analysis_agent 关闭")
    logger.info("=" * 60)
